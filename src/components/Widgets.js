...
export default function Widgets({ newsResults, randomUsersResults }) {
  ...
  const [randomUserNum, setRandomUser] = useState(3);
  return (
    <div className="xl:w-[600px] hidden lg:inline ml-8 space-y-5">
      <div className="w-[90%] xl:w-[75%] sticky top-0 bg-white py-1.5 z-50">
        <div className="flex item-center p-3 rounded-full bg-red-300 relative w-[90%] xl:w-[75%] mb-4">
        ...
        <div className="text-gray-700 space-y-3 bg-gray-100 rounded-xl pt-2 w-[90%] xl:w-[75%] mb-4">
